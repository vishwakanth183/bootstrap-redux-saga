...
const FAQ = () => {
    ...
    const faqData = [
        ...
        },
        {
            ...
            answer: "Yes, we offer delivery services through various delivery partners."
        },
        {
            question: "Are there gluten-free options available?",
            answer: "Yes, we have a selection of gluten-free dishes available on our menu."
        },
        {
            question: "Do you have a kids' menu?",
            answer: "Yes, we offer a special menu designed for kids with a variety of options."
        },
        {
        ...
        },
        {
            ...
            answer: "Yes, we offer catering services for various events. Please contact us for more details."
        },
        {
            question: "Can I customize my order?",
            answer: "Yes, we are happy to accommodate special requests and dietary restrictions. Please let us know your preferences when ordering."
        },
        {
            question: "Do you have outdoor seating?",
            answer: "Yes, we have a lovely outdoor seating area for you to enjoy your meals."
        }
    ];
    ...
    return (
        <div className="container pb-5" id="FAQ">
